function diff = objective_function(nbd,p,TF_conc_t,RNApH_conc_t,RNApA_conc_t,mut_mat,real_data,n_strain,group_array)
...
if n_strain > 1
    ...
    parfor mm = 1:n_strain
        sim_data(:,mm) = time_dep_TR_new_wSigma(nbd,energyi,TF_conc_t,RNApH_conc_t,RNApA_conc_t,mut_mat(mm,:),vmax_array,group_array);
    end
end
if n_strain == 1
    sim_data = time_dep_TR_new_wSigma(nbd,energyi,TF_conc_t,RNApH_conc_t,RNApA_conc_t,mut_mat,vmax_array,group_array);
end
