function [diff,energyi_s,energyi_v,vmax_arrays,vmax_arrayv] = objective_function_together(nbd,p,TF_conc_t,H_conc_t,A_conc_t,mut_mats,mut_matv,real_datas,real_datav,n_strains,n_strainv,...
